package com.logosty.learning.leetcode.section3000.part309;

/**
 * @author logosty(ganyingle) on 2024/7/19 16:12
 * description: 3096. 得到更多分数的最少关卡数目 中等
...
public class Solution3096 {
    public int minimumLevels(int[] possible) {
        ...
        int need = total > 0 ? total / 2 + 1 : (total + 1) / 2;
        int count = 0;
